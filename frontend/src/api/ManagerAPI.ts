...
class ManagerAPI {
    ...
    static editManagers = (values: {
      ...
      return axios.put(`${BASE_URL}/manager/${values.id}`, manager, requestConfigJson);
    }
    ...
    static editSupplier = (values: {
      ...
      return axios.put(`${BASE_URL}/supplier/${values.id}`, supplier, requestConfigJson);
    }
    ...
    static editProduct = (values: {
      ...
      return axios.put(`${BASE_URL}/product/${values.id}`, product, requestConfigJson);
    }
    ...
    static editOrder = (values: {
      ...
      return axios.put(`${BASE_URL}/order/${values.id}`, order, requestConfigJson);
    }
